...
export function HTTP(props: PropsType) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M10.59 13.41a1 1 0 001.41 0l5.66-5.66a1 1 0 00-1.41-1.41l-5.66 5.66a1 1 0 000 1.41z" />
      <path 
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4.93 19.07a6 6 0 008.49 0l1.42-1.41a6 6 0 000-8.49l-1.42-1.42a6 6 0 00-8.49 8.49l1.41 1.42a1 1 0 001.42-1.42l-1.41-1.42a4 4 0 015.66-5.66l1.42 1.41a4 4 0 010 5.66l-1.42 1.42a4 4 0 01-5.66-5.66 1 1 0 10-1.42-1.42 6 6 0 000 8.49l1.41 1.42z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path 
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 1.75a.75.75 0 01.75.75v1.09c2.444.243 4.25 1.697 4.25 3.66 0 1.95-1.572 3.2-4.087 3.456l-.163.016V14.5h.25c2.527 0 4.5 1.387 4.5 3.5s-1.973 3.5-4.5 3.5v.75a.75.75 0 01-1.5 0v-.75c-2.527 0-4.5-1.387-4.5-3.5 0-1.95 1.572-3.2 4.087-3.456l.163-.016v-3.778h-.25c-2.527 0-4.5-1.387-4.5-3.5 0-2.032 1.806-3.417 4.25-3.66V2.5a.75.75 0 01.75-.75zm0 13.75h-.25c-1.657 0-3 .833-3 2s1.343 2 3 2h.25v-4zm1.5-7.25v3h.25c1.657 0 3-.833 3-2s-1.343-2-3-2h-.25z"
        fill="currentColor"
        />
    </svg>
  );
